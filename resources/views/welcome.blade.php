...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>J. G. Moreira - São Gotardo, MG</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="jhonathan, gleidsom, moreira, são, gotardo, são gotardo, designer, programador, administrador, marketing, escritor" name="keywords">
        <meta content="Jhonthan Gleidsom Moreira é graduado em Administração, pós-graduado em Engenharia de Software" name="description">
            ...
            <div class="content">
                ...
                <div class="header" id="header">
                    <div class="content-inner">
                        ...
                        <h1>J. G.  Moreira</h1>
                        <h2></h2>
                        <div class="typed-text">Administrador, Escritor, Desenvolvedor</div>
                    </div>
                </div>
                <!-- Header End -->
                ...
                <div class="large-btn">
                    <div class="content-inner">
                        <a class="btn" href="#"><i class="fa fa-download"></i>Currículo</a>
                        <a class="btn" href="#"><i class="fa fa-hands-helping"></i>Contato</a>
                    </div>
                </div>
                <!-- Large Button End -->
